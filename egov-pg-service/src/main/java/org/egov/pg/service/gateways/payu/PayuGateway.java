...
public class PayuGateway implements Gateway {
	...
	public PayuGateway(RestTemplate restTemplate, Environment environment, ObjectMapper objectMapper) {
		...
		this.ORIGINAL_RETURN_URL_KEY = environment.getRequiredProperty("original.return.url.key");
		this.GATEWAY_RETURN_URL = environment.getRequiredProperty("gateway.return.url");
	}
	...
	public URI generateRedirectURI(Transaction transaction) {
		...
		params.add("surl", getReturnUrl(transaction.getCallbackUrl(), this.GATEWAY_RETURN_URL));
		params.add("furl", getReturnUrl(transaction.getCallbackUrl(), this.GATEWAY_RETURN_URL));
