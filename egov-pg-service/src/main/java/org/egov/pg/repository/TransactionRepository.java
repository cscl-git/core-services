...
public class TransactionRepository {
	...
	private static final RefundTransactionRowMapper refundTransactionRowMapper = new RefundTransactionRowMapper();
	...
	public List<RefundTransaction> fetchRefundTransactions(TransactionCriteria transactionCriteria) {
		List<Object> params = new ArrayList<>();
		String query = TransactionQueryBuilder.getPaymentSearchRefundQueryByCreatedTimeRange(transactionCriteria,
				params);
		log.debug(query);
		return jdbcTemplate.query(query, params.toArray(), refundTransactionRowMapper);
	}
