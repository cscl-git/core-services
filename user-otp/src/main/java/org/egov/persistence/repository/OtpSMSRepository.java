...
public class OtpSMSRepository {
	private static final String SMS_REGISTER_OTP_MESSAGE = "Dear Citizen, Welcome to mChandigarh Application. Your OTP to complete your mChandigarh Registration is %s ";
	private static final String SMS_LOGIN_OTP_MESSAGE = "Dear Citizen, Your mChandigarh Application Login OTP is %s";
